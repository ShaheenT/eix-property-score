...
create table if not exists public.property_extraction_runs (
  ...
  constraint property_extraction_runs_status_check check (status in ('queued','processing','extracted','insufficient_data','extraction_failed','unsupported_source','blocked')),
