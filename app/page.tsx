...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#F7F4EE] text-[#20231F]">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-[#2A2D27]/10 bg-[#FFFDF8] p-5 shadow-[0_28px_80px_rgba(42,45,39,.12)] sm:p-7">
              ...
              <div className="px-1 pb-1 pt-6">
                <div className="flex items-start justify-between gap-4">
                  <div><p className="text-[10px] font-semibold uppercase tracking-[.22em] text-[#0E847B]">EiX Property Score™</p><h2 className="mt-2 text-2xl font-semibold tracking-tight">Evidence before opinion.</h2><p className="mt-2 text-sm text-[#3E413B]">A decision record, not a black-box answer.</p></div>
      ...
      <section id="pricing" className="mx-auto max-w-6xl px-6 py-20 sm:px-10 sm:py-28"><div className="text-center"><span className="text-xs font-semibold uppercase tracking-[.2em] text-[#0E847B]">Founding Beta Pricing</span><h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">One property. One decision report. R149.</h2><p className="mx-auto mt-4 max-w-xl leading-7 text-[#3E413B]">Founding Beta pricing while we build the full EiX Property Intelligence platform.</p></div><div className="mt-12 grid items-start gap-8 lg:grid-cols-2"><PricingCard /><div id="form"><LeadForm /></div></div></section>

      <section className="mx-auto max-w-4xl px-6 pb-16"><div className="rounded-2xl border border-[#D8D1C4] bg-[#FFFDF8] p-6 text-xs leading-6 text-[#4F524C]"><strong className="text-[#20231F]">Important:</strong> EiX Property Score™ is a decision-support tool, not a substitute for a professional property inspection, conveyancer, attorney, bank valuation, financial adviser or other professional due diligence. Scores and estimates depend on the evidence available and the assumptions used.</div></section>

      <footer className="border-t border-[#2A2D27]/10 bg-[#EEE9DF] px-6 py-8 sm:px-10"><div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 sm:flex-row"><img src="/images/eix-property-score-logo.svg" alt="EiX Property Score" className="h-11 w-auto object-contain" /><p className="text-xs text-[#4F524C]">Evidence-based property decision intelligence for South Africa. © 2026 EiX. All rights reserved.</p></div></footer>
      <Toaster />
    </main>
  );
}
