...
export const EXPECTED_CORE_FACTS: Record<string, ExpectedCoreFacts> = {
  ...
  'Harcourts Camps Bay': { titleContains: '5 Bedroom House For Sale in Camps Bay', propertyType: 'House', askingPriceCents: 3499500000, bedrooms: 5, bathrooms: 5, landSizeM2: 775, floorSizeM2: 350 },
  'Century 21 Woodstock': { titleContains: '2 Bedroom Apartment For Sale in Woodstock', propertyType: 'Apartment', askingPriceCents: 169900000, bedrooms: 2, bathrooms: 1, floorSizeM2: 42 },
};
